  ...
  <NuxtLayout>
    ...
    <v-app class="animated-background">
      <v-app-bar>
        ...
        <v-list v-else>
          <v-btn size="small"  variant="flat" class="font" @click="router.push('/')">
            <v-list-item-icon>
              <v-icon >mdi-home-outline</v-icon>
            </v-list-item-icon>
          </v-btn>  
          <v-btn size="small"  variant="flat" class="font" @click="router.push('/portfolio')">
          Portfolio
          </v-btn> 
          <v-btn size="small" variant="flat" class="font" @click="router.push('/about')">
            Connect
          </v-btn>
        </v-list>
      </v-app-bar>
